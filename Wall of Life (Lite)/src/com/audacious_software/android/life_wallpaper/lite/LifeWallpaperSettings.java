...
public final class LifeWallpaperSettings extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener
{
    ...
    public boolean onPreferenceTreeClick (PreferenceScreen preferenceScreen, Preference preference)
    {
    	...
    	else if (preference.getKey().equals("getlife"))
    	{
    		Intent myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.audacious_software.android.wallpapers.LifeWall")); //you can make this URL dynamic 
    		startActivity(myIntent); 
    	}
